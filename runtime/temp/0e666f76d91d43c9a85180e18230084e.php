<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"E:\phpStudy\WWW\ECShop\public/../application/admin\view\logo\addLogo.html";i:1536972365;}*/ ?>
...
<div class="main-div">
<form action="admin/logo/addLogo" method="post" name="theForm" enctype="multipart/form-data" onsubmit="return is_sub()">
  <table width="100%" id="general-table">
    <tr>
      ...
      <td>
        <input type="text" name="ad_name" id="ad_name" size="35" onblur="ck_name()" /><span id='info_name'></span>
    ...
    <tr>
      ...
      <td>
        <input name="start_time" type="text" size="22" value='2018-09-06' readonly="readonly" /><button name="selbtn1" type="button" id="selbtn1" onclick="return showCalendar('start_time', '%Y-%m-%d', false, false, 'selbtn1');" class="cal"><img src="static/picture/cal.png" alt=""></button>
      </td>
    </tr>
    <tr>
      <td class="label">结束日期</td>
      <td>
        <input name="end_time" type="text" value='2018-10-06' readonly="readonly" ><button name="selbtn2" type="button" id="selbtn2" onclick="return showCalendar('end_time', '%Y-%m-%d', false, false, 'selbtn2');" class="cal"><img src="static/picture/cal.png" alt=""></button>
      </td>
    </tr>
      <tbody id="0">
    <tr>
    ...
    <tr>
      ...
      <td>
        <input type="radio" name="enabled" value="1"  checked="true"  />开启        <input type="radio" name="enabled" value="0"  />关闭      
      </td>
    </tr>
    <tr>
      <td  class="label">广告联系人</td>
      <td>
        <input type="text" name="link_man" id="link_man" size="35" onblur="ck_man()" /><span id='info_man'></span>
      </td>
    </tr>
    <tr>
      <td  class="label">联系人Email</td>
      <td>
        <input type="text" name="link_email" id="link_email" size="35" onblur="ck_email()" /><span id='info_email'></span>
      </td>
    </tr>
    <tr>
      <td  class="label">联系电话</td>
      <td>
        <input type="text" name="link_phone" id="link_phone" size="35" onblur="ck_phone()" /><span id='info_phone'></span>
      </td>
    </tr>
    <tr>
       <td class="label">&nbsp;</td>
...
function ck_name(){
  ...
  if (ad_name=='') {
    document.getElementById("info_name").innerHTML="<font color='red'>广告名称不能为空</font>"; 
    return false;
  } else{
...
function ck_man(){
  ...
  var reg = /^[\u4e00-\u9fa5]{2,4}$/;
  if (reg.test(link_man)) {
    document.getElementById('info_man').innerHTML="";
    return true;
  } else{
    document.getElementById('info_man').innerHTML="<font color='red'>联系人必须为2-4位中文</font>";
    return false;
  }
}

function ck_email(){
  var link_email = document.getElementById("link_email").value;
  var reg = /^\w{1,}@\w{1,}\.(com|cn)$/;
  if (reg.test(link_email)) {
    document.getElementById('info_email').innerHTML="";
    return true;
  } else{
    document.getElementById('info_email').innerHTML="<font color='red'>邮箱格式不正确</font>";
    return false;
  }
}
...
>>>>>>> d02279c8bd649850bebd51017af70eaa8a5973fe
  if (reg.test(link_phone)) {
    document.getElementById('info_phone').innerHTML="";
    return true;
  } else{
    document.getElementById('info_phone').innerHTML="<font color='red'>电话格式不正确</font>";
    return false;
  }
}

function is_sub(){
  if (ck_name() && ck_man() && ck_email() && ck_phone()) {
    return true;
  } else {
    return false;
  }
