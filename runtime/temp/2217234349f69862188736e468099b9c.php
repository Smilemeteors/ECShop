<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"D:\PHPTutorial\WWW\ECShop\public/../application/admin\view\goods\goods_type_manage.html";i:1536580915;}*/ ?>
...
<table width="100%" cellpadding="3" cellspacing="1" id="listTable">
    ...
    <td align="center">
      ...
      <img src="static/picture/yes.svg" class="status" id="<?php echo $v['type_id']; ?>" value='<?php echo $v['status']; ?>' width="20"/>
      <?php else: ?>
      <img src="static/picture/no.svg" class="status" id="<?php echo $v['type_id']; ?>" value='<?php echo $v['status']; ?>' width="20"/>
      <?php endif; ?>
    <td align="center">
      <a href="<?php echo url('attribute_list'); ?>?id=<?php echo $v['type_id']; ?>" title="属性列表">属性列表</a> |
      <a href="<?php echo url('goods_type_upd'); ?>?id=<?php echo $v['type_id']; ?>" title="编辑">编辑</a> |
      <a href="<?php echo url('goods_type_del'); ?>?id=<?php echo $v['type_id']; ?>" onclick="listTable.remove(1, '删除商品类型将会清除该类型下的所有属性。\n您确定要删除选定的商品类型吗？')" title="移除">移除</a>
    </td>
  </tr>
  <?php endforeach ?>
  <tr>
