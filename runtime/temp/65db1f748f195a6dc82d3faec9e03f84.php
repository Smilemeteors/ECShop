<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\PHPTutorial\WWW\ECShop\public/../application/admin\view\order\details.html";i:1536313508;}*/ ?>
...
<table width="100%" cellpadding="3" cellspacing="1">
  ...
  <tr>
    ...
    <td><span class="require-field">*</span><a href="order.php?act=edit&order_id=1&step=payment" class="btn btn-def">编辑</a>    (备注: <span onclick="listTable.edit(this, 'edit_pay_note', 1)">N/A</span>)</td>
  ...
  <tr>
    <th colspan="4">其他信息<a href="order.php?act=edit&order_id=1&step=other" class="btn btn-def">编辑</a></th>
    </tr>
  <tr>
  ...
  <tr>
    <th colspan="4">收货人信息<a href="order.php?act=edit&order_id=1&step=consignee" class="btn btn-def">编辑</a></th>
    </tr>
  <tr>
...
<table width="100%" cellpadding="3" cellspacing="1">
  <tr>
    <th colspan="8" scope="col">商品信息<a href="order.php?act=edit&order_id=1&step=goods" class="btn btn-def">编辑</a></th>
    </tr>
  <tr>
...
<table width="100%" cellpadding="3" cellspacing="1">
  <tr>
    <th>费用信息<a href="order.php?act=edit&order_id=1&step=money" class="btn btn-def">编辑</a></th>
  </tr>
  <tr>
...
<table cellpadding="3" cellspacing="1">
  ...
  <tr>
    ...
    <td colspan="5">         <input name="pay" type="submit" value="付款" class="button"  />
           ...
           <input name="after_service" type="submit" value="售后" class="button"  />                        <input name="order_id" type="hidden" value="1"></td>
    </tr>
  <tr>
    <th>操作者：</th>
    <th>操作时间</th>
