<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\PHPTutorial\WWW\ECShop\public/../application/admin\view\order\paytype.html";i:1536626551;}*/ ?>
﻿<!-- $Id -->
...
<link href="static/css/general_4.css" rel="stylesheet" type="text/css" />
<link href="static/css/main_4.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="static/js/transport_4.js"></script><script type="text/javascript" src="static/js/common_4.js"></script>
<style>
...
</h1><script type="text/javascript" src="static/js/utils_4.js"></script><script type="text/javascript" src="static/js/validator_1.js"></script>
<form name="theForm" action="order.php?act=step_post&step=payment&order_id=1&step_act=edit" method="post" onsubmit="return checkPayment()">
<div class="list-div">
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <td><font color="#FF0000">天工收银</font></td>
  ...
  <p align="center">
        <button><a href="admin/order/details">确定</a></button>
   <button><a href="admin/order/details">取消</a></button>
  </p>
</form>
...
<script language="JavaScript">
  ...
  function loadAddress(addressId)
  {
    ...
    location.href += 'order.php?act=edit&order_id=1&step=payment&address_id=' + addressId;
...
<div id="footer">
共执行 6 个查询，用时 0.033656 秒，Gzip 已禁用，内存占用 2.623 MB<br />
...
<!--
<embed src="static/flash/online_4.wav" width="0" height="0" autostart="false" name="msgBeep" id="msgBeep" enablejavascript="true"/>
-->
