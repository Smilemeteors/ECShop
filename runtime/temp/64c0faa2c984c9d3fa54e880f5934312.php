<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"E:\ECShop\public/../application/admin\view\goods\comment_manage_details.html";i:1536719703;}*/ ?>
...
<div class="main-div">
  <table width="100%">
    ...
    <tr>
      <td>
      <a href="mailto:ecshop@ecshop.com"></a>
        &nbsp;于      &nbsp;&nbsp;对&nbsp;&nbsp;发表评论
      </td>
    </tr>
    <tr>
    ...
    <tr>
      <td>
        <div style="overflow:hidden; word-break:break-all;">
          <table width="100%">
            <tr>
              <td><textarea style="width:100%;height:130px;" name="" form="usrform">请在此处输入文本...</textarea> </td>
            </tr>
          </table>
        </div>
        <div align="right"><b>评论等级:</b> 5&nbsp;&nbsp;<b>IP地址</b>: 180.169.8.10</div>
      </td>
    </tr>
    <tr>
      <td align="center">
...
<div class="main-div">
  <table width="100%">
    <tbody><tr>
      <td>
      管理员&nbsp;<a href="mailto:ecshop@ecshop.com"><b>admin</b></a>&nbsp;于      &nbsp;2018-09-07 15:52:46&nbsp;回复    </td>
    </tr>
    <tr>
      <td><hr color="#dadada" size="1"></td>
    </tr>
    <tr>
      <td>
        ...
        <div align="right"><b>IP地址</b>: 127.0.0.1</div>
      </td>
    </tr>
  </tbody></table>
</div>
...
<div class="main-div">
<form method="post" action="http://127.0.0.1/ECShop1/source/ecshop/admin/comment_manage.php?act=action" name="theForm" onsubmit="return validate()">
<table border="0" align="center">
  ...
  <tr>
    <td>Email:</td>
    <td><input name="email" type="text" value="1875121927@qq.com" size="30" readonly="true"></td>
  </tr>
  <tr>
    <td>回复内容:</td>
    <td><textarea name="content" cols="50" rows="4" wrap="VIRTUAL">做我儿子把！</textarea></td>
  </tr>
    <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>
      ...
      <input type="submit" name="remail" value="重发邮件" class="button">
    </td>
  </tr>
</tbody></table>
</form>
