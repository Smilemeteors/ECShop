<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\PHPTutorial\WWW\ECShop\public/../application/admin\view\order\goods.html";i:1536637977;}*/ ?>
﻿<!-- $Id -->
...
<link href="static/css/general_7.css" rel="stylesheet" type="text/css" />
<link href="static/css/main_7.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="static/js/transport_7.js"></script><script type="text/javascript" src="static/js/common_7.js"></script>
<style>
...
</h1><script type="text/javascript" src="static/js/utils_7.js"></script><script type="text/javascript" src="static/js/validator_4.js"></script>
<form name="theForm" action="order.php?act=step_post&step=edit_goods&order_id=3&step_act=edit" method="post">
<div class="list-div">
...
<form name="goodsForm" action="order.php?act=step_post&step=add_goods&order_id=3&step_act=edit" method="post" onsubmit="return addToOrder()">
<p>
...
<form action="order.php?act=step_post&step=goods&order_id=3&step_act=edit" method="post" onsubmit="return checkGoods()">
  <p align="center">
    <button><a href="admin/order/details" class="btn btn-def">确定</a></button>
    <button><a href="admin/order/details" class="btn btn-def">取消</a></button>
  </p>
</form>
...
<script language="JavaScript">
  ...
  function loadAddress(addressId)
  {
    ...
    location.href += 'order.php?act=edit&order_id=3&step=goods&address_id=' + addressId;
...
<div id="footer">
共执行 6 个查询，用时 0.014091 秒，Gzip 已禁用，内存占用 2.621 MB<br />
...
<!--
<embed src="static/flash/online_7.wav" width="0" height="0" autostart="false" name="msgBeep" id="msgBeep" enablejavascript="true"/>
-->
