<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:93:"D:\phpstudy\WWW\shixun\ECShop\public/../application/admin\view\member\user_account_check.html";i:1536843449;}*/ ?>
﻿<!-- $Id: user_account_check.htm 14216 2008-03-10 02:27:21Z testyang $ -->
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>ECSHOP 管理中心 - 到款审核 </title>
...
<!--遮罩-->
<h1>
      <a class="btn btn-right" href="user_account.php?act=list&uselastfilter=1">充值和提现申请</a>
  
    <span class="action-span1"><a href="index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;>&nbsp;&nbsp;到款审核 </span>
  <div style="clear:both"></div>
</h1><div class="main-div">
<form method="post" action="user_account.php" name="theForm" onsubmit="return validate();">
<table border="0" width="100%">
  <tr>
    <td colspan="2"><strong>会员金额信息：</strong><hr /></td>
  </tr>
  <tr>
    <td colspan="2">
    <strong>会员名称：</strong>ecshop &nbsp;&nbsp;<strong>金额：</strong>1230.00 &nbsp;&nbsp;<strong>操作日期：</strong>2018-09-13 19:38:31    &nbsp;&nbsp;<strong>类型：</strong>充值        </td>
  </tr>
  <tr>
    <td colspan="2"><strong>会员描述：</strong>在<hr /></td>
  </tr>
  <tr>
    <th width="15%" valign="middle" align="right">管理员备注：</th>
    <td width="85%">
      <textarea name="admin_note" cols="55" rows="5">执行从v</textarea>
    </td>
  </tr>
  <tr>
    <th width="15%" valign="middle" align="right">到款状态：</th>
    <td>
      <input type="radio" name="is_paid" value="0" checked="true" />未确认      <input type="radio" name="is_paid" value="1" />已完成    </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>
...
<div id="footer">
共执行 4 个查询，用时 0.012676 秒，Gzip 已禁用，内存占用 1.128 MB<br />
