<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"E:\phpStudy\WWW\ECShop Tp5\public/../application/admin\view\index\index_menu.html";i:1536148651;}*/ ?>
...
/type" target="main-frame">红包类型</a></li>
          ...
          广告管理                    <div class="submenu">
            ...
            <li id="sub-menu-ad_position" class="menu-item" onclick="showact(this, event)"><a href="admin/logo/position" target="main-frame">广告位置</a></li>
                          ...
                          <li key="08_members" class="icon-members" data-url="../member/users.html" data-key="03_users_list" name="menu" onclick="showsub(this)">
          会员管理                    <div class="submenu">
            ...
            <li id="sub-menu-10_user_account_manage" class="menu-item" onclick="showact(this, event)"><a href="admin/member/user_account_manage" target="main-frame">资金管理</a></li>
                          ...
                          <li key="10_priv_admin" class="icon-priv" data-url="../quanxi/privilege.html" data-key="admin_list" name="menu" onclick="showsub(this)">
