<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\ECShop\public/../application/admin\view\shop_config\shop_set.html";i:1536888696;}*/ ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<!-- saved from url=(0074)http://127.0.0.1/ECShop1/source/ecshop/admin/shop_config.php?act=list_edit -->
<html xmlns="http://www.w3.org/1999/xhtml"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript" src="./files/transport.js.下载"></script><script type="text/javascript" src="./files/common.js.下载"></script>
    <style>
...
<div class="panel-hint panel-icloud" id="panelCloud">
    ...
    <div class="panel-right">
        <h5 class="logo">云起</h5>
        <p>正在激活中</p>
        <iframe src="./files/saved_resource.html" frameborder="0" id="CFrame"></iframe>
...
<h1>
    ...
    <span class="action-span1"><a href="http://127.0.0.1/ECShop1/source/ecshop/admin/index.php?act=main">ECSHOP 管理中心</a> </span><span id="search_id" class="action-span1">&nbsp;&nbsp;&gt;&nbsp;&nbsp;商店设置 </span>
    <div style="clear:both"></div>
</h1><script type="text/javascript" src="./_files/utils.js.下载"></script><script type="text/javascript" src="./files/region.js.下载"></script><div class="tab-div">
    <!-- tab bar -->
    <div id="tabbar-div">
        <p>
            <span class="tab-front" id="shop_info-tab">网店信息</span><span class="tab-back" id="basic-tab">基本设置</span><span class="tab-back" id="display-tab">显示设置</span><span class="tab-back" id="shopping_flow-tab">购物流程</span><span class="tab-back" id="goods-tab">商品显示设置</span><span class="tab-back" id="sms-tab">短信设置</span>    </p>
    </div>
    <!-- tab body -->
    <div id="tabbody-div">
        <form enctype="multipart/form-data" name="theForm" action="http://127.0.0.1/ECShop1/source/ecshop/admin/shop_config.php?act=post" method="post">
            <table width="90%" id="shop_info-table" class="gk-table" style="display: table;">
                <tbody><tr>
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticeshop_title&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        商店标题:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticeqq&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        客服QQ号码:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticeww&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        淘宝旺旺:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticeskype&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        Skype:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticeym&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        Yahoo Messenger:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticemsn&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        MSN Messenger:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticeshop_logo&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        商店 Logo:
                    </td>
                    <td class="panel-par">
                        <input name="shop_logo" type="file" size="40">
                        <img src="./files/no.svg" width="16">
                        <br>
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticeuser_notice&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        用户中心公告:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticeshop_notice&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        商店公告:
                    </td>
                    <td class="panel-par">
                        <textarea name="value[121]" cols="40" rows="5">欢迎光临！</textarea>
            ...
            <table width="90%" id="basic-table" class="gk-table" style="display: none;">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticewatermark&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        水印文件:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticewatermark_alpha&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        水印透明度:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticemarket_price_rate&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        市场价格比例:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticerewrite&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        URL重写:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticeintegral_name&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        消费积分名称:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticeintegral_scale&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        积分换算比例:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticeintegral_percent&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        积分支付比例:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticestats_code&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        统计代码:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticecache_time&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        缓存存活时间（秒）:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticeenable_gzip&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        是否启用Gzip模式:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticecomment_factor&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        商品评论的条件:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticebgcolor&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        缩略图背景色:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticesend_mail_on&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        是否开启自动发送邮件:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticesend_verify_email&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        用户注册时自动发送验证邮件:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    ...
                    <td class="panel-par">
                        <label for="value_247_0"><input type="radio" name="value[247]" id="value_247_0" value="1">需要开启</label>
                        <label for="value_247_1"><input type="radio" name="value[247]" id="value_247_1" value="0" checked="true">不需要开启</label>
            ...
            <table width="90%" id="display-table" class="gk-table" style="display: none;">
                <tbody><tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticesearch_keywords&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        首页搜索的关键字:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticecurrency_format&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        货币格式:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticeimage_height&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        商品图片高度:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticecomments_number&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        评论数量:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticebought_goods&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        相关商品数量:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticeattr_related_number&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        属性关联的商品数量:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticerecommend_order&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        推荐商品排序:
                    </td>
                    <td class="panel-par">
            ...
            <table width="90%" id="shopping_flow-table" class="gk-table" style="display: none;">
                <tbody><tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticecart_confirm&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        购物车确定提示:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticeuse_how_oos&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        是否使用缺货处理:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticeinvoice_content&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        发票内容:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticemin_goods_amount&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        最小购物金额:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticesend_service_email&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        下订单时是否给客服发邮件:
                    </td>
                    <td class="panel-par">
            ...
            <table width="90%" id="sms-table" class="gk-table" style="display: none;">
                <tbody><tr>
                    <td class="label" valign="top">
                        <a href="javascript:showNotice(&#39;noticesms_shop_mobile&#39;);" title="点击此处查看提示信息"><img src="./files/notice.svg" width="16" height="16" border="0" alt="点击此处查看提示信息"></a>
                        商家的手机号码:
                    </td>
                    <td class="panel-par">
                ...
                <tr>
                    ...
                    <td class="panel-par">
                        <label for="value_805_0"><input type="radio" name="value[805]" id="value_805_0" value="1">发短信</label>
                        <label for="value_805_1"><input type="radio" name="value[805]" id="value_805_1" value="0" checked="true">不发短信</label>
...
<script type="text/javascript" src="./files/tab.js.下载"></script><script type="text/javascript" src="./files/validator.js.下载"></script>
...
<div id="footer">
    共执行 6 个查询，用时 0.027147 秒，Gzip 已禁用，内存占用 1.667 MB<br>
