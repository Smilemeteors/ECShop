<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"E:\phpStudy\WWW\ECShop Tp5\public/../application/admin\view\goods\brand_list.html";i:1536137583;}*/ ?>
  ...
  <table cellpadding="3" cellspacing="1">
    <tr>
      ...
      <th>操作</th>
        ...
        <tr>
      <td class="first-cell">
        <span style="float:right"><a href="../data/brandlogo/1240803247838195732.gif" target="_brank"><img src="static/picture/image.svg" width="16" height="16" border="0" alt=品牌LOGO /></a></span>
...
售后网点：http://www.ph...</td>
      ...
      <td align="center"><img src="static/picture/yes.svg" width="20" onclick="listTable.toggle(this, 'toggle_show', 4)" /></td>
      <td align="center">
        ...
        <tr>
      <td class="first-cell">
        <span style="float:right"><a href="../data/brandlogo/1240803352280856940.gif" target="_brank"><img src="static/picture/image.svg" width="16" height="16" border="0" alt=品牌LOGO /></a></span>
...
售后网点：http://www.am...</td>
      ...
      <td align="center"><img src="static/picture/yes.svg" width="20" onclick="listTable.toggle(this, 'toggle_show', 5)" /></td>
      <td align="center">
      ...
      <td class="first-cell">
        ...
        <span onclick="javascript:listTable.edit(this, 'edit_brand_name', 15)">仓品</span>
      </td>
      <td><a href="http://" target="_brank">http://</a></td>
      <td align="left"></td>
      <td align="right"><span onclick="javascript:listTable.edit(this, 'edit_sort_order', 15)">50</span></td>
      <td align="center"><img src="static/picture/yes.svg" width="20" onclick="listTable.toggle(this, 'toggle_show', 15)" /></td>
      <td align="center">
        <a href="brand.php?act=edit&id=15" title="编辑">编辑</a> |
        <a href="javascript:;" onclick="listTable.remove(15, '你确认要删除选定的商品品牌吗？')" title="编辑">移除</a> 
      </td>
    </tr>
        <tr>
