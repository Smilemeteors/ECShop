<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"E:\phpStudy\WWW\ECShop\public/../application/admin\view\goods\goods_add.html";i:1536889199;}*/ ?>
      ...
      <form enctype="multipart/form-data" action="" method="post" name="theForm" >
        ...
        <table width="90%" id="general-table" align="center" class="gk-table">
          ...
          <tr>
            ...
            <td>
  <select name="cat_id" onchange="hideCatDiv()" id="select">
