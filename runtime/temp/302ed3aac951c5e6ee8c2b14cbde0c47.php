<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"E:\phpStudy\WWW\ECShop\public/../application/admin\view\goods\goods_add.html";i:1537449777;}*/ ?>
...
<div class="tab-div">
    ...
    <!-- tab body -->
    <div id="tabbody-div">
      <form action="<?php echo url('goods_add_do'); ?>" method="post" name="theForm" enctype="multipart/form-data">
        <!-- 鏈€澶ф枃浠堕檺鍒 -->
        ...
        <option value="1">北京供货商</option><option value="2">上海供货商</option>      </select></td>
          ...
          <tr id="promote_4">
            ...
            <td id="promote_6" class="cal-group">
              <input name="promote_start_date" type="text" id="promote_start_date" size="12" value='2018-09-08' readonly="readonly"><button type="button" class="cal" name="selbtn1" id="selbtn1" onclick="return showCalendar('promote_start_date', '%Y-%m-%d', false, false, 'selbtn1');"><img src="static/picture/cal.png" alt=""></button> - <input name="promote_end_date" type="text" id="promote_end_date" size="12" value='2018-10-08' readonly="readonly" /><button type="button" class="cal" name="selbtn2" id="selbtn2" onclick="return showCalendar('promote_end_date', '%Y-%m-%d', false, false, 'selbtn2');"><img src="static/picture/cal.png" alt=""></button>
            </td>
          </tr>
         <tr>
        ...
        <table width="90%" id="groupgoods-table" style="display:none" align="center">
          ...
          <tr>
            <td colspan="3">
              ...
              <select name="cat_id2"><option value="0">所有分类<option value="26" >家用电器</option><option value="27" >&nbsp;&nbsp;&nbsp;&nbsp;大家电</option><option value="30" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;家电配件</option><option value="31" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;洗衣机</option><option value="28" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;平板电脑</option><option value="32" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;冰箱</option><option value="29" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;家用空调</option><option value="25" >数码时尚</option><option value="18" >智能硬件</option><option value="22" >移动电源</option><option value="12" >充值卡</option><option value="1" >手机类型</option><option value="4" >&nbsp;&nbsp;&nbsp;&nbsp;3G手机</option><option value="3" >&nbsp;&nbsp;&nbsp;&nbsp;小型手机</option><option value="6" >手机</option><option value="8" >&nbsp;&nbsp;&nbsp;&nbsp;耳机</option><option value="9" >&nbsp;&nbsp;&nbsp;&nbsp;电池</option><option value="19" >配件</option><option value="24" selected='ture'>&nbsp;&nbsp;&nbsp;&nbsp;数码时尚</option><option value="20" >&nbsp;&nbsp;&nbsp;&nbsp;保护壳</option><option value="16" >服装</option></select>
...
<div id="footer">
共执行 10 个查询，用时 0.033489 秒，Gzip 已禁用，内存占用 1.993 MB<br />
