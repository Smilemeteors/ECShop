<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"D:\PHPTutorial\WWW\ECShop\public/../application/admin\view\order\consignee.html";i:1536626877;}*/ ?>
﻿<!-- $Id -->
...
<link href="static/css/general_6.css" rel="stylesheet" type="text/css" />
<link href="static/css/main_6.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="static/js/transport_6.js"></script><script type="text/javascript" src="static/js/common_6.js"></script>
<style>
...
</h1><script type="text/javascript" src="static/js/utils_6.js"></script><script type="text/javascript" src="static/js/validator_3.js"></script><script type="text/javascript" src="static/js/region_1.js"></script>
<script type="text/javascript">
region.isAdmin=true;
</script>
<form name="theForm" action="order.php?act=step_post&step=consignee&order_id=3&step_act=edit" method="post" onsubmit="return checkConsignee()">
<div class="list-div">
<table cellpadding="3" cellspacing="1">
    <tr>
    <th width="150" align="left">收货人：</th>
    <td><input name="consignee" type="text" value="" />
  ...
  <tr>
    <th align="left">手机：</th>
    <td><input name="mobile" type="text" value="" /></td>
  </tr>
  </table>
</div>
...
<script language="JavaScript">
  ...
  function loadAddress(addressId)
  {
    ...
    location.href += 'order.php?act=edit&order_id=3&step=consignee&address_id=' + addressId;
...
<div id="footer">
共执行 5 个查询，用时 0.038417 秒，Gzip 已禁用，内存占用 2.620 MB<br />
...
<!--
<embed src="static/flash/online_6.wav" width="0" height="0" autostart="false" name="msgBeep" id="msgBeep" enablejavascript="true"/>
-->
