<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"E:\phpStudy\WWW\ECShop\public/../application/admin\view\goods\attribute_upd.html";i:1536363559;}*/ ?>
...
<h1>
  ...
  <form action="<?php echo url('goods/attribute_upd_do'); ?>"  method="post" name="theForm" onsubmit="return validate();">
  ...
  <table width="100%" id="general-table">
      <tr>
        ...
        <td>
          <input type='text' name='attr_name' value="<?php echo $v['attr_name']; ?>" size='30' />
      ...
      <tr>
        ...
        <td>
          ...
          不需要检索          <input type="radio" name="" value="1"  />
          关键字检索          <input type="radio" name="" value="2"  />
