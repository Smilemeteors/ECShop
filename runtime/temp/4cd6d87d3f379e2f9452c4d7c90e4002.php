<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"D:\PHPTutorial\WWW\ECShop\public/../application/admin\view\order\other.html";i:1536626081;}*/ ?>
﻿<!-- $Id -->
...
<link href="static/css/general_5.css" rel="stylesheet" type="text/css" />
<link href="static/css/main_5.css" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="static/js/transport_5.js"></script><script type="text/javascript" src="static/js/common_5.js"></script>
<style>
...
</h1><script type="text/javascript" src="static/js/utils_5.js"></script><script type="text/javascript" src="static/js/validator_2.js"></script>
<form name="theForm" action="order.php?act=step_post&step=other&order_id=3&step_act=edit" method="post">
<div class="list-div">
</div><br />
<div class="list-div">
<table cellpadding="3" cellspacing="1">
    <tr>
    <th>客户给商家的留言：</th>
    <td><textarea name="postscript" cols="60" rows="3"></textarea></td>
  </tr>
  <tr>
    <th>缺货处理：</th>
    <td><input name="how_oos" type="text" value="" size="40" /></td>
  </tr>
  <tr>
    <th>商家给客户的留言：</th>
    <td><textarea name="to_buyer" cols="60" rows="3"></textarea></td>
  </tr>
</table>
</div>
  <p align="center">
...
<script language="JavaScript">
  ...
  function loadAddress(addressId)
  {
    ...
    location.href += 'order.php?act=edit&order_id=3&step=other&address_id=' + addressId;
...
<div id="footer">
共执行 5 个查询，用时 0.047432 秒，Gzip 已禁用，内存占用 2.620 MB<br />
...
<!--
<embed src="static/flash/online_5.wav" width="0" height="0" autostart="false" name="msgBeep" id="msgBeep" enablejavascript="true"/>
-->
