<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"E:\phpStudy\WWW\ECShop\public/../application/home\view\index\flow.html";i:1537314115;}*/ ?>
...
<title>购物流程_ECSHOP演示站 - Is shop</title>
...
<div class="top-bar">
 ...
 欢迎光临本店<a href="user.html">请登录 <strong></strong></a>&nbsp;|&nbsp;&nbsp;<a href="user.html?act=register">免费注册</a>  </font> </div>
    </div>
    <div class="bar-cart">
...
<div class="block box">
 <div id="ur_here">
  <div class="path"><div>当前位置: <a href="index.html">首页</a> <code>&gt;</code> 购物流程</div></div> </div>
</div>
...
<div class="block">
  ...
  <script type="text/javascript" src="/static1/js/showdiv.js"></script>  <script type="text/javascript">
  ...
  <div class="flowBox">
    <h6><span>商品列表</span></h6>
        <form id="formCart" name="formCart" method="post" action="flow.html">
        ...
        <table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#dddddd">
          <tr>
            <td bgcolor="#ffffff"><a href="./"><img src="/static1/picture/continue.gif" alt="continue" /></a></td>
            <td bgcolor="#ffffff" align="right"><a href="flow.html?step=checkout"><img src="/static1/picture/checkout.gif" alt="checkout" /></a></td>
          </tr>
        </table>
