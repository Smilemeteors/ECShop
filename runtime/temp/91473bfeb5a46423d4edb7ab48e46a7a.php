<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:66:"E:\ECShop\public/../application/admin\view\system\accuse_list.html";i:1536908058;}*/ ?>
...
<form method="POST" action="<?php echo url('admin/system'); ?>" name="listForm" onsubmit="return confirm_bath()">
<!-- start comment list -->
