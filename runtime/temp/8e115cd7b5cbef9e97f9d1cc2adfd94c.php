...
<div class="main-div">
  <table width="100%">
    ...
    <tr>
      <td>
        <a href=""><?php echo $v['user_name']; ?></a>&nbsp;于     <?php echo $v['add_time']; ?> &nbsp;&nbsp;对
        <b><?php echo $v['goods_id']; ?></b>&nbsp;&nbsp;发表评论
      </td>
    </tr>
    <?php endforeach ?>
    <tr>
    ...
    <tr>
      <td>
        ...
        <div align="right"><b>评论等级:</b><?php echo $v['review_rating']; ?>&nbsp;&nbsp;<b>IP地址:</b><?php echo $v['ipcade']; ?></div>
      </td>
    </tr>
    <tr>
      <td align="center">
...
<div class="main-div">
  <table width="100%">
    <?php foreach ($arr2 as $key => $v): ?>
    <tbody><tr>
      <td>
      管理员&nbsp;<a href=""><b><?php echo $v['user_name']; ?></b></a>&nbsp;于      &nbsp;<?php echo"date('Y-n-j H:m:s')"?>&nbsp;回复    </td>
    </tr>
    <tr>
      <td><hr color="#dadada" size="1"></td>
    </tr>
