...
<div class="nav-menu">
  <div class="wrap">
    <div class="logo"><a href="http://www.ecshop4.0.com/home/index/index.html" name="top"><img src="./智能相机_数码时尚_配件_ECSHOP演示站 - Powered by ECShop_files/logo.gif"></a></div>
...
<div class="block box">
  <div id="ur_here"> <div class="path"><div>当前位置: <a href="http://www.ecshop4.0.com/home/index/index.html">首页</a> <code>&gt;</code> <a href="http://www.ecshop4.0.com/home/index/category.html?id=19">配件</a> <code>&gt;</code> <a href="http://www.ecshop4.0.com/home/index/category.html?id=24">数码时尚</a> <code>&gt;</code> 智能相机</div></div> </div>
</div>
<div class="blank"></div>
<div class="block clearfix">
  ...
  <div class="AreaR">
    ...
    <div id="goodsInfo" class="clearfix">
      ...
      <div class="imgInfo">
                <img src="images/72_G_1462956048145.jpg" alt="智能相机">
      ...
      <div class="textInfo">
        <form action="javascript:addToCart(72)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY">
          ...
          <ul>
            ...
            <li class="clearfix">
              <dd>
                                <strong>商品品牌：</strong><a href="http://www.ecshop4.0.com/home/index/brand.html?id=15">仓品</a>
                              </dd>
              <dd class="ddR">
    ...
    <div class="box clearfix">
      <div class="box_1 goods-boxg">
        ...
        <div id="com_v" class="boxCenterList RelaArticle"> <p>&nbsp;<img src="./智能相机_数码时尚_配件_ECSHOP演示站 - Powered by ECShop_files/5984c3f800d7ef3c.jpg" alt=""></p> </div>
        <div id="com_h" class="none">
          <blockquote> <p>&nbsp;<img src="./智能相机_数码时尚_配件_ECSHOP演示站 - Powered by ECShop_files/5984c3f800d7ef3c.jpg" alt=""></p> </blockquote>
          <blockquote>
          ...
          <input type="hidden" name="goods_id" value="72">
                ...
                function submitTag(frm)
                {
                  try
                  {
                    ...
                    {
                      Ajax.call('user.html?act=add_tag', "id=" + idx + "&tag=" + tag, submitTagResponse, "POST", "JSON");
                    }
                  }
                  catch (e) {alert(e);}
                  return false;
                ...
                function submitTagResponse(result)
                {
                  ...
                  else
                  {
                    try
                    {
                      ...
                      {
                        div.innerHTML += '<a href="search.html?keywords='+tags[i].word+'" style="color:#006ace; text-decoration:none; margin-right:5px;">' +tags[i].word + '[' + tags[i].count + ']<\/a>&nbsp;&nbsp; ';
                      }
                    }
                    catch (e) {alert(e);}
                  }
     ...
     <div class="box_1">
      ...
      <div class="boxCenterList">
       ...
       <div id="buy_pagebar" class="f_r" style="margin-top:10px">
        <form name="selectPageForm" action="http://www.ecshop4.0.com/home/index/goods.html" method="get">
                <div id="buy_pager">
      ...
      <form action="javascript:;" onsubmit="submitComment(this)" method="post" name="commentForm" id="commentForm">
       <table width="710" border="0" cellspacing="5" cellpadding="0">
        ...
        <tr>
          ...
          <td>
          <input name="comment_rank" type="radio" value="1" id="comment_rank1"> <img src="./智能相机_数码时尚_配件_ECSHOP演示站 - Powered by ECShop_files/stars1.gif">
          <input name="comment_rank" type="radio" value="2" id="comment_rank2"> <img src="./智能相机_数码时尚_配件_ECSHOP演示站 - Powered by ECShop_files/stars2.gif">
          <input name="comment_rank" type="radio" value="3" id="comment_rank3"> <img src="./智能相机_数码时尚_配件_ECSHOP演示站 - Powered by ECShop_files/stars3.gif">
          <input name="comment_rank" type="radio" value="4" id="comment_rank4"> <img src="./智能相机_数码时尚_配件_ECSHOP演示站 - Powered by ECShop_files/stars4.gif">
          <input name="comment_rank" type="radio" value="5" checked="checked" id="comment_rank5"> <img src="./智能相机_数码时尚_配件_ECSHOP演示站 - Powered by ECShop_files/stars5.gif">
          </td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <img src="./智能相机_数码时尚_配件_ECSHOP演示站 - Powered by ECShop_files/captcha.html" alt="captcha" onclick="this.src=&#39;captcha.html?&#39;+Math.random()" class="captcha">
          </div>
...
//  }
  ...
  if (cmt.email.length > 0)
  {
   ...
   Ajax.call('comment.html', 'cmt=' + cmt.toJSONString(), commentResponse, 'POST', 'JSON');
   return false;
}
...
function changePrice()
{
  ...
  Ajax.call('goods.html', 'act=price&id=' + goodsId + '&attr=' + attr + '&number=' + qty, changePriceResponse, 'GET', 'JSON');
}
/**
 * 接收返回的信息
 */
