<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\PHPTutorial\WWW\ECShop\public/../application/admin\view\order\cost.html";i:1536637957;}*/ ?>
﻿<!-- $Id -->
...
<form name="theForm" action="order.php?act=step_post&step=money&order_id=3&step_act=edit" method="post">
<div class="list-div">
<table cellpadding="3" cellspacing="1">
  <tr>
    <th width="120">商品总金额：</th>
    <td width="150">￥0.00元</td>
  <th width="120">折扣：</th>
    <td><input name="discount" type="text" id="discount" value="0.00" size="15" /></td>
  </tr>
  <tr>
    <th>发票税额：</th>
    <td><input name="tax" type="text" id="tax" value="0.00" size="15" /></td>
    <th>订单总金额：</th>
    <td>￥0.00元</td>
  </tr>
  <tr>
  ...
  <tr>
    <th>支付费用：</th>
    <td><input name="pay_fee" type="text" value="0.00" size="15"></td>
  <th>使用积分：</th>
    <td> 可用积分：0</td>
  </tr>
  <tr>
...
<script language="JavaScript">
  ...
  function loadAddress(addressId)
  {
    ...
    location.href += 'order.php?act=edit&order_id=3&step=money&address_id=' + addressId;
...
<div id="footer">
共执行 5 个查询，用时 0.035119 秒，Gzip 已禁用，内存占用 2.620 MB<br />
