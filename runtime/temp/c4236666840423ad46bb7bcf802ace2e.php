<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:68:"E:\ECShop\public/../application/admin\view\goods\attribute_list.html";i:1536319718;}*/ ?>
  ...
  <table cellpadding="3" cellspacing="1">
    ...
    <?php foreach ($arr as $key => $v): ?>
      ...
      <td align="center" nowrap="true" valign="top">
        <a href="<?php echo url(''); ?>?id=<?php echo $v['attr_id']; ?>" title="编辑">编辑</a>
        <a href="<?php echo url(''); ?>?id=<?php echo $v['attr_id']; ?>" onclick="removeRow(1)" title="移除">移除</a>
      </td>
    </tr>
    <?php endforeach ?>
      </table>
