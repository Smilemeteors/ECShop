<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"E:\phpStudy\WWW\ECShop\public/../application/home\view\user\userinfo.html";i:1537449777;}*/ ?>
...
<div class="block box">
 <div id="ur_here">
  <div class="path"><div>当前位置: <a href="http://www.ecshop4.0.com/home/index/index">首页</a> <code>&gt;</code> 用户中心</div></div> </div>
</div>
    ...
    <div class="box">
     ...
     <form name="formEdit" action="user.html" method="post" onsubmit="return userEdit()">
      <table width="100%" cellspacing="1" cellpadding="5" border="0" bgcolor="#dddddd">
                <tbody><tr>
                  <td width="28%" bgcolor="#FFFFFF" align="right">出生日期： </td>
                  <td width="72%" bgcolor="#FFFFFF" align="left"> <select name="birthdayYear"><option value="1958">1958</option><option value="1959">1959</option><option value="1960" selected="selected">1960</option><option value="1961">1961</option><option value="1962">1962</option><option value="1963">1963</option><option value="1964">1964</option><option value="1965">1965</option><option value="1966">1966</option><option value="1967">1967</option><option value="1968">1968</option><option value="1969">1969</option><option value="1970">1970</option><option value="1971">1971</option><option value="1972">1972</option><option value="1973">1973</option><option value="1974">1974</option><option value="1975">1975</option><option value="1976">1976</option><option value="1977">1977</option><option value="1978">1978</option><option value="1979">1979</option><option value="1980">1980</option><option value="1981">1981</option><option value="1982">1982</option><option value="1983">1983</option><option value="1984">1984</option><option value="1985">1985</option><option value="1986">1986</option><option value="1987">1987</option><option value="1988">1988</option><option value="1989">1989</option><option value="1990">1990</option><option value="1991">1991</option><option value="1992">1992</option><option value="1993">1993</option><option value="1994">1994</option><option value="1995">1995</option><option value="1996">1996</option><option value="1997">1997</option><option value="1998">1998</option><option value="1999">1999</option><option value="2000">2000</option><option value="2001">2001</option><option value="2002">2002</option><option value="2003">2003</option><option value="2004">2004</option><option value="2005">2005</option><option value="2006">2006</option><option value="2007">2007</option><option value="2008">2008</option><option value="2009">2009</option><option value="2010">2010</option><option value="2011">2011</option><option value="2012">2012</option><option value="2013">2013</option><option value="2014">2014</option><option value="2015">2015</option><option value="2016">2016</option><option value="2017">2017</option><option value="2018">2018</option><option value="2019">2019</option></select>&nbsp;<select name="birthdayMonth"><option value="1">01</option><option value="2">02</option><option value="3" selected="selected">03</option><option value="4">04</option><option value="5">05</option><option value="6">06</option><option value="7">07</option><option value="8">08</option><option value="9">09</option><option value="10">10</option><option value="11">11</option><option value="12">12</option></select>&nbsp;<select name="birthdayDay"><option value="1">01</option><option value="2">02</option><option value="3" selected="selected">03</option><option value="4">04</option><option value="5">05</option><option value="6">06</option><option value="7">07</option><option value="8">08</option><option value="9">09</option><option value="10">10</option><option value="11">11</option><option value="12">12</option><option value="13">13</option><option value="14">14</option><option value="15">15</option><option value="16">16</option><option value="17">17</option><option value="18">18</option><option value="19">19</option><option value="20">20</option><option value="21">21</option><option value="22">22</option><option value="23">23</option><option value="24">24</option><option value="25">25</option><option value="26">26</option><option value="27">27</option><option value="28">28</option><option value="29">29</option><option value="30">30</option><option value="31">31</option></select> </td>
                </tr>
                <tr>
                  <td width="28%" bgcolor="#FFFFFF" align="right">性　别： </td>
                  <td width="72%" bgcolor="#FFFFFF" align="left"><input name="sex" value="0" checked="checked" type="radio">
                    保密&nbsp;&nbsp;
                ...
                <tr>
                  <td width="28%" bgcolor="#FFFFFF" align="right">电子邮件地址： </td>
                  <td width="72%" bgcolor="#FFFFFF" align="left"><input name="email" value="ecshop@ecshop.com" size="25" class="inputBg" type="text"><span style="color:#FF0000"> *</span></td>
                </tr>
						<tr>
			<td width="28%" bgcolor="#FFFFFF" align="right">QQ：</td>
			<td width="72%" bgcolor="#FFFFFF" align="left">
			<input name="extend_field2" class="inputBg" type="text">			</td>
		</tr>
								<tr>
			<td width="28%" bgcolor="#FFFFFF" align="right">办公电话：</td>
			<td width="72%" bgcolor="#FFFFFF" align="left">
			<input name="extend_field3" class="inputBg" type="text">			</td>
		</tr>
								<tr>
			<td width="28%" bgcolor="#FFFFFF" align="right">家庭电话：</td>
			<td width="72%" bgcolor="#FFFFFF" align="left">
			<input name="extend_field4" class="inputBg" type="text">			</td>
		</tr>
								<tr>
			<td id="extend_field5i" width="28%" bgcolor="#FFFFFF" align="right">手机：</td>
			<td width="72%" bgcolor="#FFFFFF" align="left">
			<input name="extend_field5" class="inputBg" type="text"><span style="color:#FF0000"> *</span>			</td>
		</tr>
								<tr>
		  <td width="28%" bgcolor="#FFFFFF" align="right">密码提示问题：</td>
		  <td width="72%" bgcolor="#FFFFFF" align="left">
		  <select name="sel_question">
		  <option value="0" selected="selected">请选择密码提示问题</option>
		...
		<tr>
		  <td width="28%" bgcolor="#FFFFFF" align="right">密码问题答案：</td>
		  <td width="72%" bgcolor="#FFFFFF" align="left">
		  <input name="passwd_answer" size="25" class="inputBg" maxlengt="20" type="text">		  </td>
		</tr>
				                <tr>
                  <td colspan="2" bgcolor="#FFFFFF" align="center"><input name="act" value="act_edit_profile" type="hidden">
     ...
     <table width="100%" cellspacing="1" cellpadding="5" border="0" bgcolor="#dddddd">
        <tbody><tr>
          <td width="28%" bgcolor="#FFFFFF" align="right">原密码：</td>
          <td width="76%" bgcolor="#FFFFFF" align="left"><input name="old_password" size="25" class="inputBg" type="password"></td>
        </tr>
        <tr>
          <td width="28%" bgcolor="#FFFFFF" align="right">新密码：</td>
          <td bgcolor="#FFFFFF" align="left"><input name="new_password" size="25" class="inputBg" type="password"></td>
        </tr>
        <tr>
          <td width="28%" bgcolor="#FFFFFF" align="right">确认密码：</td>
          <td bgcolor="#FFFFFF" align="left"><input name="comfirm_password" size="25" class="inputBg" type="password"></td>
        </tr>
        <tr>
          <td colspan="2" bgcolor="#FFFFFF" align="center"><input name="act" value="act_edit_password" type="hidden">
...
function showPop(item,order_sn){
 ...
 slb.style.display = 'block';
  try
  {
    if (order_sn)
    {
      Ajax.call('user.html?act=ajax_delivery_info', "order_sn=" + order_sn , deliveryResponse, "POST", "JSON");
    }
  }
  catch (e) {alert(e);}
}
...
function checkIpt(item,type=1){
  ...
  if(type==1){
    ...
    Ajax.call('user.html?is_ajax=1&act=get_yunqi_online',post, yunqi_online, 'POST', 'JSON');
  }else{
    var post = 'rec_id=&pid=&yunqi_paymethod='+val;
    Ajax.call('user.html?is_ajax=1&act=get_yunqi_online_balance',post, yunqi_online, 'POST', 'JSON');
  }
