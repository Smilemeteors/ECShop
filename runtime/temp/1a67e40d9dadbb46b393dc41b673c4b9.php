<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\phpstudy\WWW\shixun\ECShop\public/../application/admin\view\quanxi\privilege.html";i:1536226881;}*/ ?>
...
<table cellspacing='1' cellpadding='3' id='list-table'>
  ...
  <?php foreach ($list as $key => $v) { ?>
    <tr>
      ...
      <td align="center">
        <a href="privilege.php?act=allot&id=2&user=<?=$v['admin_email'];?>" title="分派权限">分派权限</a>&nbsp;
